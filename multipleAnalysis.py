...
utils.plot_error_bars(keys, 'input (%)', step_values, 'steps', step_values_err, sum_values[0].step.dec_count, save_name=save_name)
...
utils.plot_error_bars(keys, 'input (%)', live_count_slope, 'live count slope', live_count_slope_err, sum_values[0].live_count_slope.dec_count, save_name=save_name)
...
utils.plot_error_bars(keys, 'input (%)', max_distance_slope, 'max distance slope', max_distance_slope_err, sum_values[0].max_distance_slope.dec_count, save_name=save_name)
...
utils.plot_error_bars(keys, 'input (%)', min_distance_slope, 'min distance slope', min_distance_slope_err, sum_values[0].min_distance_slope.dec_count, save_name=save_name)
